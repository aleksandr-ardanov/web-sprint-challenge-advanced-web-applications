...
1. Explain what a token is used for.
   it is used in cases when we need to pass a security check to get an access to the data

2. What steps can you take in your web apps to keep your data secure?
   create a login form and if username and password matches, server returns a token.
   with this token we can get an access to some pages/actions.
   also, some pages can be secured with private route, if we don't have token or token is wrong we won't get any data

3. Describe how web servers work.
   hardware - it stores the code for different websites which should be accessible all over the world all the time,
   software - it controls how user access hosted files
